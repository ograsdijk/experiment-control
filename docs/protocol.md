...
Response:
- `{"ok": true, "result": {"rules": [{"rule_id": "r0", "name": "power_setter_laser_ch1", "enabled": true, "device_id": "SynthHD", "trigger_action": "set_frequency", "trigger_param": "freq_hz", "channel": 0, "min_freq_hz": 1.0, "max_freq_hz": 2.0, "csv_path": "...", "effects": [{"device_id": "SynthHD", "action": "set_power", "param": "dbm", "channel": 0}]}]}}`
