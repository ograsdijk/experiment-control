...
device_class_path = (
    repo_root / "src" / "experiment_control" / "drivers" / "nkt_driver.py"
)
device_class_name = "NKTBasik"
...
def stop_all_managed() -> None:
    ...
    rpc({"type": "device.driver.stop", "device_id": "basik"})
